...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/logrus-stackdriver-formatter/HEAD/1'
...
export MINK_IMAGE='ghcr.io/jenkins-x/logrus-stackdriver-formatter:0.2.7'
