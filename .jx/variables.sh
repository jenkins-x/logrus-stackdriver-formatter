...
export APP_NAME='logrus-stackdriver-formatter'
...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/logrus-stackdriver-formatter/master/1'
...
export MINK_IMAGE='ghcr.io/jenkins-x/logrus-stackdriver-formatter:0.2.5'
export NAMESPACE_SUB_DOMAIN='-jx.'
export PIPELINE_KIND='release'
export PUSH_CONTAINER_REGISTRY='ghcr.io'
export REPO_NAME='logrus-stackdriver-formatter'
